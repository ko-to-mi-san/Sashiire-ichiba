 ...
 <body>
  ...
  <!--  <div class="search">
                <form method="post" enctype="multipart/form-data">
                 ...
                 <div class="category">
                    <input type="radio" name="category" value="100"> お菓子<br>
                    <input type="radio" name="category" value="200">食べ物<br>
                    <input type="radio" name="category" value="300">ボディケア<br>
                    <input type="radio" name="category" value="400">その他消耗品
                 </div>
                 <div class="option">
                     ...
                     <input type="checkbox" name="daininzu" value="100">大人数向け
                 </div>
                  <input type="submit" name="submit" value="検索">
            </form>
            </div>
        <div class="flex">
            <p>価格：　シーズン：　カテゴリー：　オプション：</p>-->
                <main>
                <div class="lineup">
                <?php 
                $i = 0;
                    foreach($rows as $row){
                        if($row['status'] === '1' && $row['category'] === '100') {
